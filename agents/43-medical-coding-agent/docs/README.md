...
Reviews clinical notes and assigns accurate ICD-10 and CPT codes to accelerate claims submission

## Architecture

```
43-medical-coding-agent/
├── src/
...
```bash
cd agents/43-medical-coding-agent
...
```bash
docker build -t 43-medical-coding-agent .
