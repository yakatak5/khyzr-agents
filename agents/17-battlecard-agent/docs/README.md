...
Monitors competitor websites and content to auto-update sales battlecards with positioning and objection handling
...
```bash
docker build -t 17-battlecard-agent .
