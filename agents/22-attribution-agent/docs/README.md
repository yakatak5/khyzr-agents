...
Maps touchpoints across the funnel and generates attribution reports per campaign or channel

## Architecture

```
22-attribution-agent/
├── src/
...
```bash
cd agents/22-attribution-agent
...
```bash
docker build -t 22-attribution-agent .
