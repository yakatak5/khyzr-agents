...
Scans databases, financials, and news to identify and rank acquisition targets by strategic fit

## Architecture

```
04-deal-sourcing-agent/
├── src/
...
```bash
cd agents/04-deal-sourcing-agent
...
```bash
docker build -t 04-deal-sourcing-agent .
