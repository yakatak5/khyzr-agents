...
Monitors goal progress across teams and flags misalignments or off-track items to leadership automatically

## Architecture

```
07-okr-tracking-agent/
├── src/
...
```bash
cd agents/07-okr-tracking-agent
...
```bash
docker build -t 07-okr-tracking-agent .
