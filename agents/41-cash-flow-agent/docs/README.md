...
Synthesizes AR aging, AP schedules, and historical patterns to produce rolling 13-week cash flow forecasts
...
```bash
docker build -t 41-cash-flow-agent .
