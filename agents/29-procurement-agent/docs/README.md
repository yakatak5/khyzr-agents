...
Manages RFQ distribution, collects vendor responses, and scores proposals based on predefined criteria

## Architecture

```
29-procurement-agent/
├── src/
...
```bash
cd agents/29-procurement-agent
...
```bash
docker build -t 29-procurement-agent .
