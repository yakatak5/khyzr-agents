...
Generates ad variants, monitors performance metrics, and shifts budget toward top performers automatically

## Architecture

```
19-ad-optimization-agent/
├── src/
...
```bash
cd agents/19-ad-optimization-agent
...
```bash
docker build -t 19-ad-optimization-agent .
