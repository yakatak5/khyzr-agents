...
Pulls GL data and auto-generates income statements, balance sheets, and cash flow statements

## Architecture

```
37-financial-reporting-agent/
├── src/
...
```bash
cd agents/37-financial-reporting-agent
...
```bash
docker build -t 37-financial-reporting-agent .
