...
Synthesizes internal data, market research, and frameworks (SWOT, Porter's) into draft strategic plans

## Architecture

```
03-strategy-document-agent/
├── src/
...
```bash
cd agents/03-strategy-document-agent
...
```bash
docker build -t 03-strategy-document-agent .
