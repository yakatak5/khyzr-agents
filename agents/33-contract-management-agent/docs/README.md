...
Extracts key terms from vendor contracts, tracks renewal dates, and flags unfavorable clauses

## Architecture

```
33-contract-management-agent/
├── src/
...
```bash
cd agents/33-contract-management-agent
...
```bash
docker build -t 33-contract-management-agent .
