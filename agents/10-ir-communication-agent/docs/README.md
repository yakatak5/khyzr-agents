...
Drafts earnings call scripts, investor Q&A prep, and shareholder communications from financial data

## Architecture

```
10-ir-communication-agent/
├── src/
...
```bash
cd agents/10-ir-communication-agent
...
```bash
docker build -t 10-ir-communication-agent .
