...
Extracts invoice data, matches POs, flags discrepancies, and routes for approval automatically

## Architecture

```
36-ap-automation-agent/
├── src/
...
```bash
cd agents/36-ap-automation-agent
...
```bash
docker build -t 36-ap-automation-agent .
