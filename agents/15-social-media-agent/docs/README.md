...
Creates, schedules, and monitors social posts across platforms; flags comments needing human response
...
```bash
cd agents/15-social-media-agent
...
```bash
docker build -t 15-social-media-agent .
