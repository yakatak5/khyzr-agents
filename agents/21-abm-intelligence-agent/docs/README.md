...
Researches target accounts and auto-generates personalized outreach assets per account

## Architecture

```
21-abm-intelligence-agent/
├── src/
...
```bash
cd agents/21-abm-intelligence-agent
...
```bash
docker build -t 21-abm-intelligence-agent .
