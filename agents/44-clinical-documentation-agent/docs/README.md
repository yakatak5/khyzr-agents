...
Generates structured SOAP notes and discharge summaries from physician dictation or visit transcripts

## Architecture

```
44-clinical-documentation-agent/
├── src/
...
```bash
cd agents/44-clinical-documentation-agent
...
```bash
docker build -t 44-clinical-documentation-agent .
