...
Analyzes historical sales, seasonality, and market signals to generate demand forecasts and inventory recommendations

## Architecture

```
24-demand-forecasting-agent/
├── src/
...
```bash
cd agents/24-demand-forecasting-agent
...
```bash
docker build -t 24-demand-forecasting-agent .
