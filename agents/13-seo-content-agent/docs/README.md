...
Researches keywords, drafts blog posts, and publishes content on a cadence to improve organic search rankings

## Architecture

```
13-seo-content-agent/
├── src/
...
```bash
cd agents/13-seo-content-agent
...
```bash
docker build -t 13-seo-content-agent .
