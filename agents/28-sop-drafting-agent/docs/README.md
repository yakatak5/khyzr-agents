...
Converts process descriptions or recordings into structured, formatted SOPs ready for team use

## Architecture

```
28-sop-drafting-agent/
├── src/
...
```bash
cd agents/28-sop-drafting-agent
...
```bash
docker build -t 28-sop-drafting-agent .
