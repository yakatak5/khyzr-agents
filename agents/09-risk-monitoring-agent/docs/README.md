...
Scans internal and external signals to identify emerging strategic, operational, and geopolitical risks

## Architecture

```
09-risk-monitoring-agent/
├── src/
...
```bash
cd agents/09-risk-monitoring-agent
...
```bash
docker build -t 09-risk-monitoring-agent .
